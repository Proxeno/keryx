...
2. **Zero NuGet dependencies in shipping libraries.** The BCL is the only platform. Cryptographic
   ...
   Test and benchmark projects may use xunit/FluentAssertions/BenchmarkDotNet, and the benchmark
   project references SIPSorcery solely as the comparison baseline.
